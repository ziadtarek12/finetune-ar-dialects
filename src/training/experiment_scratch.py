...
if __name__ == "__main__":
    ...
    os.environ["TRANSFORMERS_CACHE"] = f"model_cache_{args.dialect}_scratch"
    os.environ["HF_HOME"] = f"hf_cache_{args.dialect}_scratch"
    ...
    for seed in [42, 84, 168]:
        ...
        trainer = Seq2SeqTrainer(
            ...
            callbacks=[early_stopping_callback, TimingCallback(args.dialect, "scratch", seed)],
        )
