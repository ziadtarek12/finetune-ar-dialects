...
model_name = f"otozz/whisper-small-ar_tsize_{train_size}"
...
common_voice = load_from_disk("test")
...
for seed in [42, 84, 168]:
    ...
    with open(f"results_common_voice{train_size}_seed{seed}.json", "w") as f:
        json.dump(results, f)
